...
ActiveRecord::Schema.define(version: 2021_07_12_053619) do
  ...
  create_table "plan_contact_forms", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
  ...
  create_table "product_stats", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.bigint "product_id", null: false
  ...
  create_table "sessions", force: :cascade do |t|
    ...
    t.datetime "expires"
    t.boolean "impersonated", default: false
  ...
  add_foreign_key "project_configs", "projects"
